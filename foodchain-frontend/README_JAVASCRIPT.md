# FoodChain Frontend - JavaScript Version

Frontend sederhana untuk platform donasi makanan blockchain FoodChain. Dibangun dengan React 19, JavaScript (tanpa TypeScript), dan Tailwind CSS.
...
## 📁 Struktur Project - JavaScript Version

```
client/
├── src/
│   ├── pages/              # Halaman aplikasi (JavaScript)
...
│   │   └── ThemeContext.tsx
│   ├── lib/
│   │   └── api.js          # API client untuk backend (JavaScript)
│   ├── App.jsx             # Main router (JavaScript)
...
Frontend terhubung ke backend FoodChain melalui API client di `client/src/lib/api.js`.
...
- **Language**: JavaScript (tanpa TypeScript)
...
1. Buat file di `client/src/pages/` dengan extension `.jsx`
2. Tambahkan route di `App.jsx`
3. Import dan gunakan komponen

### Menambah API Endpoint
1. Tambahkan method di `client/src/lib/api.js`
...
## ✨ Perbedaan dengan TypeScript Version

- **Tanpa Type Checking**: Lebih fleksibel untuk development cepat
- **File Extensions**: `.jsx` untuk React components, `.js` untuk utilities
- **Lebih Sederhana**: Tidak perlu compile TypeScript
- **Lebih Ringan**: Ukuran bundle sedikit lebih kecil
- **Lebih Mudah**: Cocok untuk developer yang lebih suka JavaScript vanilla
